...
```txt
candidate: changed parser recovery
claim: malformed input now reports a span
oracle: parser fixture malformed-03 passed
boundary: private parser behavior
limit: does not cover streaming parser
route: apply or review
```
