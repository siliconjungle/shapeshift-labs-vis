...
<RunCausalGraphChart caption="A run is not just a timeline. Attempts, failures, answers, evidence, and decisions all have causal links." />
...
<RunLaneConvergenceChart caption="A run can have several lanes moving at once. The decision should see how those lanes converged, not just the last message." />
...
decision accept patch
  depends on patch p42
  depends on test result t17
  depends on review r8
  depends on answer h3
```
