...
<FourVersionMergeView
  example="import-set"
  caption="The useful proof is not only that each branch looked valid. It is that the exact output is derived from the exact base, worker, and head versions."
/>
...
<AdmissionChecklist
  ...
  rows={[
    {
      label: 'Base named',
      detail: 'The proof starts from the common source both branches shared.',
    },
    {
      label: 'Worker named',
      detail: 'The candidate addition is tied to the worker source that produced it.',
    },
    {
      label: 'Head named',
      detail: 'The candidate is checked against the shared state that exists now.',
    },
    {
      label: 'Output named',
      detail: 'The admitted source is its own object, not an implicit side effect of applying a patch.',
    },
  ]}
/>
