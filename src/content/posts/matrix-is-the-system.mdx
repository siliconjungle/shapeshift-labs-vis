...
proof level: import set evidence

claim: public API preserved
proof level: declaration output proof

claim: CSS selector target preserved
proof level: selector target graph

claim: browser behavior preserved
proof level: runtime proof bundle
```
